...
# p words.select {|word| word.slice(0) == 'w'}
...
# p words.select { |word| word.split("").length < 4}
...
# p items.select {|item| item[:name].split("").length < 6}
...
# p strings.select {|word| word.slice(0) != 'b'}
